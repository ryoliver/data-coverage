...
#find covearge
sbatch $src/workflow/run_coverage.sh mammals 1950 2022 gbif-wi
sbatch $src/workflow/run_coverage.sh mammals 1950 2022 gbif
sbatch $src/workflow/run_coverage.sh mammals 1950 2022 wi
